...
> **In-app:** The same guide is available at `/help/pulse` inside the HRMS. Every Pulse view (Hub tile, My Team tab, admin Pulse page) has a "How is this calculated?" link to it.

---

## Where you see your score

| Role | Where |
|---|---|
| You | My Portal → **Hub** tab → the Pulse tile |
| Your reporting manager | My Team → **Pulse** tab |
| HR / Admin / Project Coordinator | `/performance/pulse` — org-wide grid |
| Peers | Cannot see your score. No public leaderboard. |
...
|---|---|---|
| 85 – 100 | **Excellent** | Sustained high performance across pillars. Great month. |
| 70 – 84 | **Strong** | Good shape. A single weak pillar is usually all that's between you and Excellent. |
| 50 – 69 | **Building** | Below comfort zone. Use the breakdown to spot which 1–2 pillars are pulling you down. |
| 0 – 49 | **Needs support** | Worth a conversation with your manager. Score this low usually means multiple pillars are off, not just one bad week. |
...
**Formula:**
- Start at 100
- Each unplanned absence subtracts 15
- Each leave-without-notice subtracts 20

**How to improve:**
- Apply for leave in advance — even an hour ahead helps.
...
**Formula:**
- 70% — days logged ÷ working days
- 30% — days with notes ÷ days logged
...
**Formula:**
- 60 baseline for everyone
- +10 per upsell raised, capped at 100
...
**Formula:**
- Monday prompt: 🙂 = 100, 😐 = 60, 😞 = 20
- Average of the last 4 weekly ratings.
- Fewer than 2 ratings → pillar redistributes (no penalty).
...
### 7. Project Hygiene *(project coordinators only)*

**Measures:** How cleanly projects run end-to-end.
...
### 8. Client Handling *(managers + coordinators)*

**Measures:** How well you handle client interactions.

**Formula:**
- Sourced from the monthly review's **Client Handling** slider (0–100).
- Latest month's rating wins.
- Rubric: messaging quality · handling tough clients · interaction · retention.
...
### Does Pulse replace my manual monthly review?
...
### Will Pulse affect appraisals or compensation?
...
Don't obsess over week-to-week wiggle; look at the **monthly trend** in My Portal → Pulse drawer or My Team → Pulse tab.

---

*Questions about your own score? Open My Portal → Hub → tap the Pulse tile → "How is this calculated?" or speak to HR / your reporting manager.*
